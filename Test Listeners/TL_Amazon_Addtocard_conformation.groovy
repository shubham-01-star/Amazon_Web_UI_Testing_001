...
class TL_Amazon_Addtocard_conformation {
	/**
	...
	def sampleAfterTestCase() {
		WebUI.click(findTestObject('Object Repository/Amazon_Addtocard_conformation_OR/Page_Amazon.com Shopping Cart/i_hm-icon nav-sprite'))
		
		WebUI.click(findTestObject('Object Repository/Amazon_Addtocard_conformation_OR/Page_Amazon.com Shopping Cart/a_Sign Out'))
